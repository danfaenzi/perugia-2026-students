...
$i,j \in \leftbrace 1,\ldots,s\rightbrace$ such that $x = v p_i$ and $y = w p_j$, with $v,w \in A$ invertible. Therefore, $xy\mid f,$ so $f\in(xy)$. We have proved that $\sqrt{(xy)}\subseteq(xy).$
