...
Examples and applications of the results mentioned below
can be part of the question;
the results may be asked in a simplified or slighlty modified form.
